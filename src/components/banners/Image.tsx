          ...
          <div className="flex flex-col gap-6 max-md:gap-30">
            <div className="grid lg:grid-cols-[1.2fr_1fr] grid-cols-1">
              <div className="space-y-2 w-full text-center lg:text-left">
                <p className="flex mx-auto lg:mx-0 bg-white/20 backdrop-blur-2xl  items-center max-lg:text-[10px] gap-2 text-sm text-white w-fit border border-primary py-1.5 px-3 rounded-full uppercase tracking-widest">
                  <span>
                    <DotIcon />
                  </span>
                  {tag}
