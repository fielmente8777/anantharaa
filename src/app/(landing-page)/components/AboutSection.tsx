...
export const StatsCard: React.FC<AboutSectionProps["stats"][0] & { index: number }> = ({
  value,
  label,
  index,
}) => {
  return (
    <div className={`flex flex-col gap-2 max-lg:items-center ${index === 2 ? "max-lg:col-span-2 max-lg:items-center" : ""}`}>
